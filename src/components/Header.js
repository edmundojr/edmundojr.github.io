...
export default class Header extends Component {
  render() {
    ...
    const Dribbble = () => {
      return (
        <a className="nav__social__item" href="https://dribbble.com/edmundojr">
    ...
    const Instagram = () => {
      return (
        <a className="nav__social__item" href="https://instagram.com/manfromanotherland">
          <svg width="24" height="24">
    ...
    const GitHub = () => {
      return (
        <a className="nav__social__item" href="https://github.com/edmundojr">
          <svg width="24" height="24">
    ...
    const Twitter = () => {
      return (
        <a className="nav__social__item" href="https://twitter.com/edmundojr_">
          <svg width="24" height="24">
    ...
    return (
      <header className="header" role="banner">
        ...
        <label className="nav-toggle__icon" htmlFor="nav-toggle"><span></span></label>
        <Logo />
        <nav className="nav">
          <Logo />
          <Link to="/" className={"nav__item " + isHome}>Work</Link>
          <Link to="/blog/" className={"nav__item " + isBlog}>Journal</Link>
          <Link to="/about/" className={"nav__item " + isAbout}>About</Link>
