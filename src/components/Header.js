...
export default class Header extends Component {
  render() {
    ...
    const Dribbble = () => {
      return (
        <a className="nav-panel__social__item" href="https://dribbble.com/edmundojr">
    ...
    const Instagram = () => {
      return (
        <a className="nav-panel__social__item" href="https://instagram.com/manfromanotherland">
          <svg width="24" height="24">
    ...
    const GitHub = () => {
      return (
        <a className="nav-panel__social__item" href="https://github.com/edmundojr">
          <svg width="24" height="24">
    ...
    const Twitter = () => {
      return (
        <a className="nav-panel__social__item" href="https://twitter.com/edmundojr_">
          <svg width="24" height="24">
